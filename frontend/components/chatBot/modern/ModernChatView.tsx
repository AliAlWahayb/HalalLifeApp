...
const ModernChatView: React.FC = () => {
  ...
  const headerIconColor = themeName === 'dark' ? 'rgba(255, 255, 255, 0.9)' : 'rgba(0, 0, 0, 0.7)';

  const inputPlaceholderColor =
    themeName === 'dark' ? 'rgba(255, 255, 255, 0.5)' : 'rgba(0, 0, 0, 0.4)';
  ...
  const renderSettingsModal = () => {
    ...
    return (
      <Modal
        ...
        <View style={[styles.settingsModalContainer, { backgroundColor: modalOverlayColor }]}>
          <TouchableOpacity
      ...
      <KeyboardAvoidingView
        ...
        <View
          style={[
            ...
            {
              backgroundColor:
                themeName === 'dark' ? 'rgba(255, 255, 255, 0.08)' : 'rgba(0, 0, 0, 0.04)',
