...
const posts = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1523368749929-6b2bf370dbf8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Post image (food)
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1529676468696-f3a47aba7d5d?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Post image (coffee)
  ...
  },
  {
    ...
    image: 'https://plus.unsplash.com/premium_photo-1687904479711-026c1c3abdf0?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', // Post image (vegan)
          ...
          <View className="bg-white rounded-lg shadow-lg mb-4 p-4">
            ...
            <View className="flex-row justify-between items-center">
              <View className="flex-row items-center">
                ...
                <Text className="text-sm text-gray-600 ml-2">{post.likes} Likes</Text>
              </View>
              <View className="flex-row items-center">
                <Icon name="comment" size={16} color="#2196F3" />
                <Text className="text-sm text-gray-600 ml-2">{post.comments} Comments</Text>
              </View>
            </View>
          </View>
        </TouchableOpacity>
